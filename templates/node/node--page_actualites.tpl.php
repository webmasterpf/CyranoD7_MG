...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>">
    ...
    <?php  print render($title_prefix); ?>
         <?php if ($title): ?><h1 class="titre_page-actu"><?php print $title; ?></h1><?php endif; ?>
       ...
       ?>
        ...
        <div id="colonne-2" class="col2_layout_295_385_295">
            ...
            <?php
              ...
              <?php if (!empty($page['actuAssociation'])): ?>
            <div class="rss-pf"><?php print render ($page['actuAssociation']); ?></div>
            <?php endif; ?>
