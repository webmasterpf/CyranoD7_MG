...
<div class="node <?php print $classes; ?>" id="node-<?php print $node->nid; ?>">
    <div class="node-inner">
        ...
        <div id="colonne-1" class="col1_layout_215_520_235">
            ...
            <?php if (!empty($content['field_illustration_actu'])): ?>
            <div id="actu-illustration">
            <?php  print render($content['field_illustration_actu']);  ?>
            </div>
            <?php endif;?> 
    ...
    <?php endif; ?>
       ...
       ?>
        ...
        <div id="colonne-3" class="col3_layout_215_520_235">
            ...
            <div id="taxo-custom"> <?php print render($content['taxonomy_vocabulary_1']);?></div>
